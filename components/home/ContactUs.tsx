    ...
    return (
        <section className="bg-white dark:bg-gray-900">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <p className="mb-5 text-red-800 text-sm text-center dark:text-gray-400">Got a technical issue? Want to send feedback about a beta feature? Need details about our Business plan? Let us know.</p>
                <form action="#" className="space-y-8">
                    ...
                    <button type="submit" className="mb-1 w-fit rounded-3xl bg-red-100 px-5 py-4 text-sm font-semibold text-red-900 hover:bg-red-800 hover:text-white lg:mb-0 lg:w-fit lg:py-4">Send message</button>
                </form>
            </div>
        </section>
    );
